...
package com.nikhilesh.learning.liferay.guestbook.service;
 ...
 * {@link com.nikhilesh.learning.liferay.guestbook.service.impl.EntryLocalServiceImpl} and is the
 ...
 * @see com.nikhilesh.learning.liferay.guestbook.service.base.EntryLocalServiceBaseImpl
 * @see com.nikhilesh.learning.liferay.guestbook.service.impl.EntryLocalServiceImpl
 * @generated
 */
@ProviderType
public class EntryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.nikhilesh.learning.liferay.guestbook.service.impl.EntryLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.nikhilesh.learning.liferay.guestbook.model.Entry addEntry(
		com.nikhilesh.learning.liferay.guestbook.model.Entry entry) {
	...
	*/
	public static com.nikhilesh.learning.liferay.guestbook.model.Entry createEntry(
		long entryId) {
	...
	*/
	...
	public static com.nikhilesh.learning.liferay.guestbook.model.Entry fetchEntry(
		long entryId) {
	...
	*/
	public static com.nikhilesh.learning.liferay.guestbook.model.Entry fetchEntryByUuidAndGroupId(
	...
	* @throws PortalException if a entry with the primary key could not be found
	*/
	public static com.nikhilesh.learning.liferay.guestbook.model.Entry getEntry(
		long entryId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static com.nikhilesh.learning.liferay.guestbook.model.Entry getEntryByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	...
	public static com.nikhilesh.learning.liferay.guestbook.model.Entry updateStatus(
	...
	*/
	...
	public static int getEntriesCount(long groupId, long EntryId) {
		return getService().getEntriesCount(groupId, EntryId);
	}

	public static int getEntriesCount(long groupId, long EntryId, int status) {
		return getService().getEntriesCount(groupId, EntryId, status);
	}
	...
	*/
	...
	public static java.util.List<com.nikhilesh.learning.liferay.guestbook.model.Entry> getEntries(
		long groupId, long EntryId) {
		return getService().getEntries(groupId, EntryId);
	}

	public static java.util.List<com.nikhilesh.learning.liferay.guestbook.model.Entry> getEntries(
		long groupId, long EntryId, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getEntries(groupId, EntryId, start, end);
	}

	public static java.util.List<com.nikhilesh.learning.liferay.guestbook.model.Entry> getEntries(
		long groupId, long EntryId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<com.nikhilesh.learning.liferay.guestbook.model.Entry> obc) {
		return getService().getEntries(groupId, EntryId, start, end, obc);
	}

	public static java.util.List<com.nikhilesh.learning.liferay.guestbook.model.Entry> getEntries(
		long groupId, long EntryId, int status) {
		return getService().getEntries(groupId, EntryId, status);
	}

	public static java.util.List<com.nikhilesh.learning.liferay.guestbook.model.Entry> getEntries(
		long groupId, long EntryId, int status, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getEntries(groupId, EntryId, status, start, end);
	}

	public static java.util.List<com.nikhilesh.learning.liferay.guestbook.model.Entry> getEntries(
		long groupId, long EntryId, int status, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<com.nikhilesh.learning.liferay.guestbook.model.Entry> obc) {
		return getService().getEntries(groupId, EntryId, status, start, end, obc);
	}
	...
	*/
	public static java.util.List<com.nikhilesh.learning.liferay.guestbook.model.Entry> getEntriesByUuidAndCompanyId(
	...
	*/
	public static java.util.List<com.nikhilesh.learning.liferay.guestbook.model.Entry> getEntriesByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<com.nikhilesh.learning.liferay.guestbook.model.Entry> orderByComparator) {
		return getService()
