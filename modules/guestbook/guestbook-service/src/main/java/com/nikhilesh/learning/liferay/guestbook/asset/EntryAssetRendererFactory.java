package com.nikhilesh.learning.liferay.guestbook.asset;
...
import com.nikhilesh.learning.liferay.guestbook.service.permission.EntryPermission;
...
public class EntryAssetRendererFactory extends BaseAssetRendererFactory<Entry> {
	...
	public boolean hasPermission(PermissionChecker permissionChecker, 
		...
		Entry entry = _entryLocalService.getEntry(classPK);
		return EntryPermission.contains(permissionChecker, entry.getEntryId(), actionId);
	}
	...
	public PortletURL getURLView(LiferayPortletResponse liferayPortletResponse, WindowState windowState) {
		...
		LiferayPortletURL liferayPortletURL = liferayPortletResponse.createLiferayPortletURL(GuestbookPortletKeys.GUESTBOOK, PortletRequest.RENDER_PHASE);
    ...
    @Reference(target = "(osgi.web.symbolicname=com.nikhilesh.learning.liferay.guestbook.web)", unbind = "-")
	...
	public static final String TYPE = "guestbook-entry";
