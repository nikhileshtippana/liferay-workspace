...
import com.nikhilesh.learning.liferay.guestbook.service.permission.GuestbookPermission;
...
public class GuestbookAssetRendererFactory extends BaseAssetRendererFactory<Guestbook> {
	...
	public boolean hasPermission(PermissionChecker permissionChecker, 
		...
		Guestbook guestbook = _guestbookLocalService.getGuestbook(classPK);
		return GuestbookPermission.contains(permissionChecker, guestbook.getGuestbookId(), 
				actionId);
	}
    ...
    @Reference(unbind = "-")
    protected void setEntryLocalService(GuestbookLocalService guestbookLocalService) {
