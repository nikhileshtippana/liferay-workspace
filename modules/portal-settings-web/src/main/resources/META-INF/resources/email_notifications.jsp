...
<liferay-ui:tabs
	names="sender,account-created-notification,email-verification-notification,password-changed-notification,password-reset-notification,custom-notification"
	refresh="<%= false %>"
>
	<liferay-ui:section>
		<aui:fieldset>
	...
	<liferay-ui:section>
		<liferay-ui:error key="emailCustomNotificationSubject" message="please-enter-a-valid-subject" />
		<liferay-ui:error key="emailCustomNotificationBody" message="please-enter-a-valid-body" />

		<liferay-frontend:email-notification-settings
			emailBody='<%= LocalizationUtil.getLocalizationXmlFromPreferences(companyPortletPreferences, renderRequest, "adminEmailCustomNotificationBody", "settings", "") %>'
			emailParam="adminEmailCustomNotification"
			emailSubject='<%= LocalizationUtil.getLocalizationXmlFromPreferences(companyPortletPreferences, renderRequest, "adminEmailCustomNotificationSubject", "settings", "") %>'
			fieldPrefix="settings"
			showEmailEnabled="<%= false %>"
		/>
