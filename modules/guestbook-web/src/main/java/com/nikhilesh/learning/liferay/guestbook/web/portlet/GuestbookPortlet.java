...
public class GuestbookPortlet extends MVCPortlet {
	...
	public void render(
		...
		try {
			...
			List<Guestbook> guestbooks = _guestbookLocalService.getGuestbooks(groupId, WorkflowConstants.STATUS_APPROVED);

			if (guestbooks.isEmpty()) {
				Guestbook guestbook = _guestbookLocalService.addGuestbook(
						serviceContext.getUserId(), "Main", serviceContext, true);
