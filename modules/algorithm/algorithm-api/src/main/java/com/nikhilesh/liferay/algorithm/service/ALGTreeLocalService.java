...
/**
 * Provides the local service interface for ALGTree. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ALGTreeLocalServiceUtil
...
public interface ALGTreeLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ALGTreeLocalServiceUtil} to access the alg tree local service. Add custom service methods to {@link com.nikhilesh.liferay.algorithm.service.impl.ALGTreeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Indexable(type = IndexableType.REINDEX)
	public ALGTree addTree(long userId, java.lang.String name,
	...
	public ALGTree addTree(long userId, java.lang.String name,
		java.lang.String description, ServiceContext serviceContext,
		boolean disableWorkflow) throws PortalException;
	...
	*/
	...
	@Indexable(type = IndexableType.DELETE)
	public ALGTree deleteTree(long treeId, ServiceContext serviceContext)
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ALGTree fetchALGTreeByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ALGTree getALGTreeByUuidAndGroupId(java.lang.String uuid,
	...
	*/
	...
	@Indexable(type = IndexableType.REINDEX)
	public ALGTree updateStatus(long userId, long treeId, int status,
		ServiceContext serviceContext) throws PortalException, SystemException;

	@Indexable(type = IndexableType.REINDEX)
	public ALGTree updateTree(long userId, long treeId, java.lang.String name,
		java.lang.String description, ServiceContext serviceContext)
		throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ALGTree> getALGTrees(long groupId, int status, int start,
		int end);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ALGTree> getALGTrees(long groupId, int status, int start,
		int end, OrderByComparator<ALGTree> obc);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ALGTree> getALGTreesByUuidAndCompanyId(java.lang.String uuid,
		long companyId);
