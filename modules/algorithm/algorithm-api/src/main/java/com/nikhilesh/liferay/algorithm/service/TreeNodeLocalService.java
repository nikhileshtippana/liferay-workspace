...
/**
 * Provides the local service interface for TreeNode. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TreeNodeLocalServiceUtil
...
public interface TreeNodeLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TreeNodeLocalServiceUtil} to access the tree node local service. Add custom service methods to {@link com.nikhilesh.liferay.algorithm.service.impl.TreeNodeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public TreeNode addTreeNode(long userId, long treeId, int value, int level,
		long parentId, ServiceContext serviceContext) throws PortalException;
	...
	*/
	...
	public TreeNode deleteTreeNode(long treeNodeId,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TreeNode fetchTreeNodeByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TreeNode getTreeNodeByUuidAndGroupId(java.lang.String uuid,
	...
	*/
	...
	public TreeNode updateTreeNode(long userId, long treeId, long treeNodeId,
		int value, int level, long parentId, ServiceContext serviceContext)
		throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TreeNode> getTreeNodes(long groupId, long treeId, int start,
		int end);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TreeNode> getTreeNodes(long groupId, long treeId, int start,
		int end, OrderByComparator<TreeNode> obc);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TreeNode> getTreeNodesByUuidAndCompanyId(
